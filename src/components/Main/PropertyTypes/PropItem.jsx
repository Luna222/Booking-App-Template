export default function PropItem(props) {
  return (
    <figure
      ...
      className="grow shrink-0 flex flex-col justify-start items-start space-y-2 group relative m-3 first-child:ml-0 last-child:mr-0 opacity-0 transform transition-all delay-150 duration-500 ease-out animate-fade-in-up"
    >
      <div className="relative">
        <img
          src={props.image}
          alt="Delightful Property"
          className="grow w-[190px] h-[150px] object-cover rounded-t-xl"
        />
